...
function App() {
  return (
      <div className="bg-black text-white min-h-screen relative overflow-hidden">
        ...
        {/* Hero Section */}
        <section id="home" className="relative flex flex-col justify-center items-center h-screen text-center">
        ...
        <section id="about" className="flex flex-col justify-center items-center py-16 bg-black text-white ">
          <h2 className="text-4xl sm:text-5xl font-bold text-teal-400 mb-6 text-center p-4">Our Domains</h2>
